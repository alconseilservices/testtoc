import { c as s } from "./p-f983d8f8.js";
...
const e = {
  ...
  conveyorBelt: {
    ...
    animation: [ {
      id: "conveyorbelt",
      pathPrefix: "./assets/lesmots/anim/tapis_roulant/Tapis_Roulant_",
      totalFrames: 50,
      soundEffect: "conveyorBelt"
    } ],
    animationDurationMs: 2e3
  },
  hammerBtn: {
...
class {
  ...
  constructor() {
    ...
    a.Sound.registerSound(s("./assets/lesmots/sound/tapis_roulant_loop.mp3"), "conveyorBelt"), 
